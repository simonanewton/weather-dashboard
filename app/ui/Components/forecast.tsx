...
const Forecast = ({ data }: { data: payload }) => {
    return (
        <div className="px-4 sm:px-8 py-4 content-center">
            <p className="pb-4 pt-2 md:pb-3 md:pt-0 text-xl md:text-lg font-semibold text-center">Hourly Forecast</p>
            ...
            <p className="pb-4 pt-8 md:pb-3 md:pt-3 text-xl md:text-lg font-semibold text-center">Weekly Forecast</p>
            <div className="grid grid-cols-1 md:grid-cols-5 justify-center gap-3 md:gap-5 md:9/12 xl:w-11/12 mx-auto">
